  ...
  chat: a
    .conversation({
      ...
      systemPrompt: [
        ...
        '',
        'RESPONSE STYLE: default to tight summaries — lead with the answer in 2–4',
        'short sentences (or up to 5 terse bullets when listing roles), then stop.',
        'Offer to expand ("want the full breakdown?") rather than volunteering it.',
        'Give full detail only when the owner explicitly asks to expand, explain,',
        'or walk through something. Numbers and labels stay precise; prose stays',
        'minimal.',
        '',
